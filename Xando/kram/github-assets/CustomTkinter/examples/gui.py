...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.home_frame_button_1 = customtkinter.CTkButton(self.home_frame, text="", image=self.home_image)
    ...
    def select_frame_by_name(self, name):
        ...
        self.frame_2_button.configure(fg_color=("gray75", "gray25") if name == "settings" else "transparent")
        self.frame_3_button.configure(fg_color=("gray75", "gray25") if name == "account" else "transparent")
